/**
 * Card game inspired by the likes of Dutch Blitz and Nerts
 * 2-6 players
 * https://cardgamer.club/
 * 
 * The goal of this project was to gain an appreciation for JS frameworks by challenging
 * myself to only use vanilla JS. Along the way, my approach was to find the lightest weight
...
fetch('/.netlify/functions/getFirebaseConfig')
  ...
  /**
   * Checks if the given pile is a valid spot to place the card currently being dragged.
   * @param {HTMLElement} pile 
   * @returns {boolean}
   */
